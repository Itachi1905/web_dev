      ...
      <div class="card work">
        ...
        <div class="card-desc">
          <div class="card-header">
            <div class="card-title">{props.id}</div>
            <div class="card-menu">
              <div class="dot"></div>
              <div class="dot"></div>
              <div class="dot"></div>
          ...
          <div class="card-time">{props.title}</div>
          <div class="card-time card-time2">{props.body}</div>

          <p class="recent">User ID :- {props.userId}</p>
        </div></div>
    </div> 
  )
}
